...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        public IActionResult CreateReview([FromQuery] int reviewerId, [FromQuery] int pokeId,[FromBody] ReviewDto reviewCreate)
        {
            ...
            {
                ModelState.AddModelError("", $"Something went wrong saving the record {reviewMap.Title}");
        ...
        public IActionResult UpdateReview(int reviewId, [FromBody] ReviewDto updatedReview)
        {
            ...
            {
                ModelState.AddModelError("", $"Something went wrong updating the record {reviewMap.Title}");
                return StatusCode(500, ModelState);
            }
        ...
        public IActionResult DeleteReview(int reviewId)
        {
            ...
            {
                ModelState.AddModelError("", $"Something went wrong deleting the record {review.Title}");
                return StatusCode(500, ModelState);
            }
